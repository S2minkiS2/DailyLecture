...
UPDATE MEMBER SET PHONE = '010-1111-1234'; -- MEMBER 테이블의 모든 PHONE 번호가 바뀐다.
ROLLBACK;

UPDATE MEMBER SET PHONE = '010-1111-1234' WHERE ID = 'HONG4';

SELECT * FROM MEMBER WHERE ID = 'HONG5';
UPDATE MEMBER SET PHONE = '010-2222-2222' WHERE ID = 'HONG5';
UPDATE MEMBER SET ADDRESS = '의정부시' WHERE ID =  'HONG4';
COMMIT;
------
-- SQL 작성 형식1 - 맨 앞에 일치시키기
UPDATE MEMBER 
SET PHONE = '010-5555-7878'
    ADDRESS = '그리스'
WHERE ID = 'HONG4';
...
UPDATE MEMBER
   SET PHONE = '010-1111-1234',
       ADDRESS = '이탈리아 알리오올리오시'
 WHERE ID = 'HONG3';
  
-- SQL 작성 형식3 - 탭 또는 일정간격 들여쓰기 = tap 들여쓰기 
UPDATE MEMBER
    SET PHONE = '010-7777-1235',
        ADDRESS = '베이징 북경오리시'
  WHERE ID = 'HONG2';
...
INSERT INTO MEMBER (ID, NAME, PASSWORD, ADDRESS)
VALUES ('SHIN', '신민기', 1234, '용인시');
        --('SHIN2', '신민아', 4567, '서울시');

SELECT * FROM MEMBER;

UPDATE MEMBER
    SET PHONE = '010-2736-6119',
        ADDRESS = '뉴질랜드'
    WHERE NAME = '신민기';
