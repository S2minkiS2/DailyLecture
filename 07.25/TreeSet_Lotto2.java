...
public class TreeSet_Lotto2 {
	...
	public static void main(String[] args) {
		...
		Set<Integer> set = new TreeSet<>(); //Set 인터페이스 타입, TreeSet도 Set하위클래스임
		...
		System.out.println("정렬 전 lottoList : " + lottoList);		// TreeSet은 정렬이 필요없다. 저절로 sort가 된다.
