...
<%
	//고전적인 방식
	MemberVO memberVO = new MemberVO(); //직접 객체생성
	memberVO.setId(request.getParameter("id")); //하나하나 설정
	memberVO.setPwd(request.getParameter("pwd")); //하나하나 설정
	
	memberVO.setHobby(request.getParameterValues("hobby")); // 배열이니까 values
