...
public class StudentDAOTest {
	...
	public static void main(String[] args) {
		...
		StudentVO stu2 = new StudentVO("2023002", "", 0, 0, 0, 0, 0);
		...
		student = new StudentVO("2023029", "홍경래", 100 , 90, 82, 0, 0);
		...
		student = new StudentVO("2023029", "홍경래2upd", 95 , 85, 75);
		...
		System.out.println("삭제할 학생 : " + dao.selectOne(student));
		student = new StudentVO("2023029", "홍경래2upd", 95 , 85, 75);
