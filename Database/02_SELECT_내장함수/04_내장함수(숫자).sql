/**********************************
--숫자연산 :SQU에서는 사칙연산(+,-,*,/)과 나머지연산(MOD)사용
<숫자 관련 내장함수>
...
--숫자연산 :SQL에서는 사칙연산(+,-,*,/)과 나머지연산(MOD)사용
SELECT 10+3, 10-3, 10*3, 10/3, MOD(10,3)FROM DUAL;

--ABS(숫자) : 절대값

--FLOOR(숫자) : 소수점날리기 / 작은 숫자 (아래쪽 숫자)를 선택한다
...
SELECT ROUND(30.45), ROUND(30.44) FROM DUAL;
SELECT ROUND(30.45, 1), ROUND(30.44, 1) FROM DUAL;
SELECT ROUND(30.445, 2), ROUND(30.444, 2) FROM DUAL;
