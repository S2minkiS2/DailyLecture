...
************************************************/
--TO_CHAR : 문자 타입으로 변환 (날짜 -> 문자, 숫자 -> 문자)
SELECT SYSDATE, TO_CHAR(SYSDATE, 'YYYY-MM-DD') FROM DUAL;
SELECT SYSDATE, TO_CHAR(SYSDATE, 'YYYY-MM-DD DAY') FROM DUAL;

SELECT SYSDATE, TO_CHAR(SYSDATE, 'YYYY-MM-DD HH:MI:SS') FROM DUAL;
SELECT SYSDATE, TO_CHAR(SYSDATE, 'YYYY-MM-DD AM:MI:SS') FROM DUAL;
--==============================
...
SELECT 123000 + 9,  TO_CHAR(123000) + 9 FROM DUAL; -- '1230000' + 9 --> 1230400
SELECT '123000' + 9 FROM DUAL ; --자동형변환(문자-->숫자) 후 덧셈연산

-- 묵시적(자동)형변환, 명시적 형변환
SELECT '123000' + 9; -- 묵시적으로 형변환됨
...
SELECT TO_DATE('2023-08-09') +1 FROM DUAL; --날짜타입 형변환하면 날짜연산 가능하지만 명시적으로 년도 위치를 정해서 
SELECT TO_DATE('2023-08-09', 'YYYY-MM-DD') + 1 FROM DUAL;
-- (주의) 날짜타입으로 형변환시에는 형식지정문자를 반드시 사용하길 권장
SELECT TO_DATE('2023-08-09', 'YYYY-MM-DD') + 1 FROM DUAL;
