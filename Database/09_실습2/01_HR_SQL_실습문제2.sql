...
-- CASE WHEN 표현식 사용 : NULL이면~ NULL이 아니면~
CASE WHEN COMMISION_PCT IS NOT NULL THEN "Salary + Commission"
     WHEN COMMISION_PCT IS NULL THEN "Salary only"
...
GROUP BY JOB_ID
HAVING NOT LIKE '%CLERK%' -- NOT LIKE!!!
...
SELECT  'HR-COMPANY', 
        (FIRST_NAME ||' '|| LAST_NAME) AS NAME, E.JOB_ID, 
