...
-----
-- DML : INSERT, UPDATE, DELETE, SUMLECT
...
-- DCL : ROLLBACK, COMMIT
--ROLLBACK; -- 되돌리기. 임시처리된 작업을 취소처리 
COMMIT; -- 임시 처리된 작업 최종 적용 (물리적으로 확정짓는다)

INSERT INTO MEMBER (ID, NAME, PASSWORD)
VALUES ('HONG2', '홍길동2', '12342');
COMMIT;

INSERT INTO MEMBER (ID, NAME, PASSWORD)
VALUES ('HONG2', '홍길동2', '12342');

--키 중복 입력시 : ORA-00001: unique constraint (MYSTUDY.SYS_C007002) violated
INSERT INTO MEMBER (ID, NAME, PASSWORD)
VALUES ('HONG2', '홍길동2', '1234');

--제약조건 : NOT NULL 컬럼데이터 미입력 오류 : ORA-01400: cannot insert NULL into ("MYSTUDY"."MEMBER"."PASSWORD")
INSERT INTO MEMBER (ID, NAME)
VALUES ('HONG3', '홍길동3');
------------------------------------
SELECT * FROM MEMBER; -- * : 전체 // 테이블에 있는 모든 데이터 + 모든 컬럼
...
COMMIT;
-------------
--컬럼을 명시적으로 작성시 해당 컬럼에 1:1 매칭되어 데이터 입력
...
WHERE ID = 'HONG4'
;
-- SQL 문장 작성 형식2 - SQL 내용 시작 위치에 일치시키기
UPDATE MEMBER
SET PHONE = '010-1111-1234', 
    ADDRESS = '서울시'
    WHERE ID = 'HONG4'
...
SELECT * FROM MEMBER WHERE ID = '홍길동'; 
UPDATE MEMBER 
SET NAME = '홍길동'
WHERE ID = 'HONG4'
;
