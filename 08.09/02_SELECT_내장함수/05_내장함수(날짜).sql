...
SELECT SYSDATE - 12102 FROM DUAL;
...
SELECT SYSDATE, TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS')
    ...
    , TO_CHAR(SYSDATE + (1/24)*5, 'YYYY-MM-DD HH24:MI:SS') --5시간 후 (하루를 24로 나누고, 곱하기 5)
    , TO_CHAR(SYSDATE + (1/24/60)*10, 'YYYY-MM-DD HH24:MI:SS') -- 10분 뒤
FROM DUAL;

--1일 : 86400초, 1440분
SELECT 1*60 AS "1분(초)", 60*60 AS "1시간(초)", 24*60*60 AS "1일(초)"
, 24*60 AS "1일(분)" -- 특수문자는 쌍따음표로 묶어줘야 해요. OR "ONE MIN"
FROM DUAL;
